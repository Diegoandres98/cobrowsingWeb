...
const FirebaseRegister = ({ row }) => {
  ...
  const handleSendPutCollector = async (values) => {
    console.log('handleSendPutCollector' + JSON.stringify(values));
    ...
    <>
      <Grid container direction="column" justifyContent="center" spacing={2}>
        <Grid item xs={12} container alignItems="center" justifyContent="center">
          <Box sx={{ mb: 2 }}>
            <Typography variant="subtitle1">Estas a punto de editar registro un cobrador existente</Typography>
          </Box>
        </Grid>
      </Grid>
